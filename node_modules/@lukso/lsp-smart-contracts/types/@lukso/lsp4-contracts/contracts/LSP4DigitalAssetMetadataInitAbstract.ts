...
export interface LSP4DigitalAssetMetadataInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): LSP4DigitalAssetMetadataInitAbstract;
  waitForDeployment(): Promise<this>;

  interface: LSP4DigitalAssetMetadataInitAbstractInterface;
