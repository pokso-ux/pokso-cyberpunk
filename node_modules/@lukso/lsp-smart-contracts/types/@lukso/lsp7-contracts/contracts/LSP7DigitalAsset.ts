...
export interface LSP7DigitalAssetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "authorizedAmountFor"
...
export interface LSP7DigitalAsset extends BaseContract {
  connect(runner?: ContractRunner | null): LSP7DigitalAsset;
  waitForDeployment(): Promise<this>;

  interface: LSP7DigitalAssetInterface;
