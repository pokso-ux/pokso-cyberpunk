...
export interface LSP7MintableInitInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "authorizedAmountFor"
  ...
  encodeFunctionData(
    ...
    values: [string, string, AddressLike, BigNumberish, boolean]
  ): string;
  encodeFunctionData(
...
export interface LSP7MintableInit extends BaseContract {
  connect(runner?: ContractRunner | null): LSP7MintableInit;
  waitForDeployment(): Promise<this>;

  interface: LSP7MintableInitInterface;
