...
export interface LSP7BurnableInitAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "authorizedAmountFor"
...
export interface LSP7BurnableInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): LSP7BurnableInitAbstract;
  waitForDeployment(): Promise<this>;

  interface: LSP7BurnableInitAbstractInterface;
