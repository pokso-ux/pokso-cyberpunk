...
export interface LSP7DigitalAssetInitAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "authorizedAmountFor"
...
export interface LSP7DigitalAssetInitAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): LSP7DigitalAssetInitAbstract;
