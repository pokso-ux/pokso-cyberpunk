...
const iPostDeploymentModuleAbi = [
  {
    type: "function",
    inputs: [
...
const universalProfileInitPostDeploymentModuleAbi = [
...
const universalProfilePostDeploymentModuleAbi = [
  { type: "constructor", inputs: [], stateMutability: "nonpayable" },
  { type: "error", inputs: [], name: "ERC725X_ContractDeploymentFailed" },
  {
    type: "error",
...
exports.iPostDeploymentModuleAbi = iPostDeploymentModuleAbi;
exports.ilsp23LinkedContractsFactoryAbi = ilsp23LinkedContractsFactoryAbi;
exports.lsp23LinkedContractsFactoryAbi = lsp23LinkedContractsFactoryAbi;
exports.universalProfileInitPostDeploymentModuleAbi = universalProfileInitPostDeploymentModuleAbi;
exports.universalProfilePostDeploymentModuleAbi = universalProfilePostDeploymentModuleAbi;
